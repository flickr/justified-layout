declare namespace justifiedLayout {
	type Items = (number | { width: number; height: number; })[];
...
declare function justifiedLayout(items: justifiedLayout.Items, options?: justifiedLayout.Options): justifiedLayout.Output;
