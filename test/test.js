...
describe('justified-layout', function() {
	...
	describe('input', function() {
		...
		xit('should handle width and height objects as input', function() {
		});
	...
	describe('config', function() {
		...
		xit('should return a layout without passing in a config', function() {

		});

		xit('it should allow overriding of containerWidth', function() {
